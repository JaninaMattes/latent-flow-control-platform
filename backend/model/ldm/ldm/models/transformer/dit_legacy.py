...
from jutils.nn import Attention
...
class DiTBlock(nn.Module):
    ...
    """
    def __init__(self, hidden_size, num_heads, mlp_ratio=4.0, legacy=False, **block_kwargs):
        super().__init__()
...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        legacy_attn=False,          # LEGACY (True for DiT and SiT)
        ...
        self.blocks = nn.ModuleList([
            DiTBlock(hidden_size, num_heads, mlp_ratio=mlp_ratio, legacy=legacy_attn) for _ in range(depth)
        ])
