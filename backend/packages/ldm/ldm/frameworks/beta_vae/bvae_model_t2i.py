...
import torch
from jutils import exists, instantiate_from_config
from torch import nn
from torch.nn import functional as F  # noqa: N812

from ldm.frameworks.beta_vae.annealer import Annealer, BetaAnnealer
from ldm.models.architecture.base_architectures import (
    BaseDecoder,
    BaseEncoder,
    BaseVAE,
)
...
class BetaVAEModel(BaseVAE):
    ...
    def encode(self, z) -> EncoderOutput:
        """
    ...
    def loss_function(self, sample, generated, dist):
        ...
        return dict(
            ...
            recon_loss=recons_loss.mean(dim=0),
